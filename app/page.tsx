  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 border-b border-border/80 bg-bg-main/90 backdrop-blur-md">
        <nav aria-label="Primary navigation" className="mx-auto flex max-w-site items-center justify-between gap-6 px-5 py-4 sm:px-8 lg:px-10">
      ...
      <main id="main-content" className="relative z-10">
        ...
        <section id="work" aria-labelledby="work-title" className="scroll-mt-24 border-t border-border">
          <Reveal className="mx-auto max-w-site px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
        ...
        <section id="journey" aria-labelledby="journey-title" className="scroll-mt-24 border-t border-border">
          <Reveal className="mx-auto grid max-w-site gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[0.7fr_1.3fr] lg:px-10 lg:py-28">
        ...
        <section id="contact" aria-labelledby="contact-title" className="scroll-mt-24 border-y border-border bg-bg-surface">
          <Reveal className="mx-auto grid max-w-site gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:px-10 lg:py-28">
            <div>
