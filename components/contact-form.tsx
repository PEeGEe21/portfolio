  ...
  return (
    <form action="https://formspree.io/f/xgedownq" method="POST" onSubmit={handleSubmit} className="rounded-lg border border-border bg-bg-main p-5 sm:p-8">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          <button type="submit" disabled={submissionState === "submitting"} className="min-h-12 w-full cursor-pointer rounded-md bg-accent px-5 py-3 font-semibold text-accent-foreground transition-opacity hover:opacity-90 disabled:cursor-wait disabled:opacity-60 flex items-center justify-center gap-3">
